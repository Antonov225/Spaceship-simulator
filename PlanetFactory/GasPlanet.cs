...
namespace Project{
    class GasPlanet : Planet{
        ...
        public GasPlanet(string _name, bool _hasSpacePort, double _hydrogen, double _food, double _oxygen, double _iron, double _silicon, double _gold) : 
        ...
        {
            return "Planet type: Gas Giant " + base.PrintInfo() + ". Available resources: Hydrogen: " + Hydrogen + " Food: " + Food + " Oxygen: " + Oxygen + 
