...
namespace Project{
    class DesertPlanet : Planet{
        ...
        public DesertPlanet(string _name, bool _hasSpacePort, double _hydrogen, double _food, double _oxygen, double _iron, double _silicon, double _gold) : 
        base(_name, _hasSpacePort){
            Hydrogen = _hydrogen;
            Food = _food;
            Oxygen = _oxygen;
            Iron = _iron;
        ...
        {
            return "Planet type: Desert Planet " + base.PrintInfo() + ". Available resources: Hydrogen: " + Hydrogen + " Food: " + Food + " Oxygen: " + Oxygen + 
